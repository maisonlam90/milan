...
export const dashboards = {
    ...
    childs: [
        ...
        },
        {
            ...
            childs: [
                {
                    id: 'dashboards.loan-1',
                    type: NAV_TYPE_ITEM,
                    path: path(ROOT_DASHBOARDS, '/loan/loan-1'),
                    title: 'loan v1',
                    transKey: 'nav.dashboards.loan-1',
                },
                {
                    id: 'dashboards.loan-2',
                    type: NAV_TYPE_ITEM,
                    path: path(ROOT_DASHBOARDS, '/loan/loan-2'),
                    title: 'loan v2',
                    transKey: 'nav.dashboards.loan-2',
                },
            ],
        },
        {
