...
export DATABASE_URL="postgres://yugabyte:Maisonlan123@192.168.1.7:5433/milan"
...
psql "postgres://yugabyte:Maisonlan123@192.168.1.7:5433/milan" \
  -c "DROP SCHEMA public CASCADE; CREATE SCHEMA public;"

// cache lai sqlx
export DATABASE_URL="postgres://yugabyte:Maisonlan123@192.168.1.8:5433/milan"
